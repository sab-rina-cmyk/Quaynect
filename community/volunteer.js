...
function showDetails(type) {
    ...
    infoGrid.innerHTML = `
        <div class="flex flex-col items-center text-center">
            <span class="material-icons-round text-primary mb-2">calendar_today</span>
            <p class="text-[13px] font-semibold text-slate-900 dark:text-white leading-tight">${data.date}</p>
            <p class="text-[11px] text-slate-500 dark:text-zinc-400">${data.time}</p>
        </div>
        <div class="flex flex-col items-center text-center border-x border-slate-100 dark:border-zinc-800">
            <span class="material-icons-round text-primary mb-2">place</span>
            <p class="text-[11px] font-medium text-slate-500 dark:text-zinc-400">Location:</p>
            <p class="text-[13px] font-semibold text-slate-900 dark:text-white leading-tight">${data.location}</p>
        </div>
        <div class="flex flex-col items-center text-center">
            <span class="material-icons-round text-primary mb-2">schedule</span>
            <p class="text-[11px] font-medium text-slate-500 dark:text-zinc-400">Commitment:</p>
            <p class="text-[13px] font-semibold text-slate-900 dark:text-white leading-tight">${data.commitment}</p>
        </div>
    `;
